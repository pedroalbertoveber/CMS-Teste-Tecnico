<x-layout>
    ...
    <svg id="sw-js-blob-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" class="max-w-[400px] -mr-28">
      <defs>
        <linearGradient id="sw-gradient" x1="0" x2="1" y1="1" y2="0">
          <stop id="stop1" stop-color="rgba(225, 29, 72, 1)" offset="0%"></stop>
          <stop id="stop2" stop-color="rgba(244, 63, 94, 1)" offset="100%"></stop>
        </linearGradient>
      </defs>
  ...
  <form 
    class="flex items-center gap-4 max-w-[800px] mx-auto mt-8"
    method="POST"
